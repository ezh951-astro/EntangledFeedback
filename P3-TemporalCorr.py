...
axs.plot( outflowtime-450., outflowrate, color='#777777', linewidth=1, linestyle='dashed', alpha=0.6)

# 4kpc
outflowtime, outflowrate = hd.moving_average( outflowdata[2,:,0], outflowdata[2,:,3], n=nAvging )
axs.plot( outflowtime-450., outflowrate, color='#aaaaaa', linewidth=1, linestyle='dotted', alpha=0.6)
...
axs.text( 10., 6.8, r'$c_{\rm Lo} = 0.673$',  color='red',    fontsize=11, alpha=0.8, ha='left', va='top' )
axs.text( 10., 6.5, r'$c_{\rm Hi} = 0.295$',  color='blue',   fontsize=11, alpha=0.8, ha='left', va='top' )
axs.text( 10., 6.2, r'$c_{\rm Tot} = 0.459$', color='purple', fontsize=11, alpha=0.8, ha='left', va='top' )

axs.text( 333., 1.43, '2 kpc', color='#777777', fontsize=11, alpha=0.6, ha='left', va='center' )
axs.text( 292., 0.18, '4 kpc', color='#aaaaaa', fontsize=11, alpha=0.6, ha='left', va='center' )
...
indH = np.argmax(ccH)
indT = np.argmax(ccT)
print( 'Low-Density Coefficient (square): {} at t={} Myr'.format( ccL[indL]**2., tlagL[indL] ) )
print( 'High-Density Coefficient (square): {} at t={} Myr'.format( ccH[indH]**2., tlagH[indH] ) )
print( 'All Coefficient (square): {} at t={} Myr'.format( ccL[indH]**2., tlagL[indH] ) )
