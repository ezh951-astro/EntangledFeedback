...
figE, axsE = plt.subplots(3,3,figsize=(11,5),gridspec_kw={ 'height_ratios':[4,0,2], 'width_ratios':[2,2,2] })
...
for kcol in range(3):
    ...
    axsE[1,kcol].set_yticks([])
    #axsE[1,kcol].set_yticklabels(['$10^{-2}$','$10^{0}$','$10^{2}$'])
    axsE[1,kcol].set_yticklabels([])
...
#figE.text( 0.062, 0.36, r'$\delta$KE / $\delta$TE',fontsize=12, rotation=90, va='center')
#figE.text( 0.062, 0.15, r'Likelihood',fontsize=12, rotation=90, va='center')

axsE[0,0].set_ylabel(r'$\Delta e$ [erg/${\rm M}_{\odot}$]',fontsize=12)
axsE[2,0].set_ylabel(r'Likelihood',fontsize=12)
...
figE.savefig('GalFresca/P6-ResolutionDiff.png',dpi=300)
plt.show()
