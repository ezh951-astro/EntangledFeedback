...
for jSim,localdata in enumerate(LocalDatas):
    if jSim==0: # LYRA (noRT)
        print('LYRA')
        for iMass,npi in enumerate([6,7,8]): # bimodality can kind of be seen at Level 4 (64 particles), barely visible at Lv 5 (128 ptcl), completely gone by Lv 6 (256 ptcl)
...
figE.text( 0.5, 0.045, r'Density [${\rm cm}^{-3}$]',fontsize=14, ha='center' )
